...
export default function Home() {
  ...
  const handleQuizSubmit = async (quizState: QuizState) => {
    ...
    trackEvent(UmamiEvents.QUIZ_COMPLETED, {
      ...
      era: quizState.era,
      mood: quizState.mood,
      decisionStyle: quizState.decisionStyle,
      workoutVibe: quizState.workoutVibe,
      catchphraseEnergy: quizState.catchphraseEnergy,
    });
    ...
    try {
      ...
      const result = await getRecommendations(quizState, apiKey);
      setPersona(result.persona);
      setMovies(result.movies);

      trackEvent(UmamiEvents.RECOMMENDATIONS_RECEIVED, {
        persona: result.persona.personaId,
        runnerUp: result.persona.runnerUp,
        count: result.movies.length.toString(),
      });
  ...
  // ItemList now lists the personas (the main output of the quiz) instead of
  // hardcoded movies. FAQ updated to reflect 7-question persona quiz.
    ...
    '@graph': [
      {
        ...
        description:
          'Arnold Schwarzenegger persona quiz. Answer 7 personality questions and discover which Arnold persona matches you — plus 2-3 recommended Arnold films.',
        url: baseUrl,
      ...
      {
        '@type': 'ItemList',
        name: 'Arnold Schwarzenegger Persona Archetypes',
        description:
          'The six Arnold personas users can be matched to in the Get to the Movie! quiz.',
        itemListElement: personaList.map((p, index) => ({
          '@type': 'ListItem',
          position: index + 1,
          name: p.name,
      ...
      },
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'Which Arnold Schwarzenegger ARE you?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Get to the Movie! matches you to one of 6 Arnold personas: Terminator, Commando, Kindergarten Cop, Total Recall, True Lies, or Mr. Freeze. Take the 7-question quiz to find out which side of Arnold you are, and get recommended films for your persona.',
            },
          },
          {
            '@type': 'Question',
            name: 'How does the Arnold persona quiz work?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: "Answer 7 personality-based questions about your mood, energy level, brain capacity, era preference, decision style, workout vibe, and catchphrase energy. The quiz scores each persona against your answers and reveals your best match — plus the runner-up — along with 2-3 Arnold films that fit that persona.",
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'It depends on your Arnold persona. Terminator Arnold favors the Terminator series, Commando Arnold leans into 80s explosion classics like Commando and The Running Man, Kindergarten Cop Arnold loves family comedies, Total Recall Arnold picks mind-bending sci-fi, True Lies Arnold enjoys action-comedy, and Mr. Freeze Arnold embraces Batman & Robin-level camp. Take the quiz for a personalized pick.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes! Get to the Movie! is completely free. Take the quiz as many times as you want to discover different Arnold personas and movie recommendations.',
            },
          },
        ],
      },
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-4">
                    <div>
                      ...
                      <p className="text-muted-foreground mt-2">
                        Movies that match your persona
                      </p>
                    </div>
                    <button
                      onClick={(e) => {
        ...
        <section className="relative z-10 container mx-auto px-4 py-16 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-3">
              ...
              <h3 className="text-lg font-semibold text-foreground">Answer 7 Questions</h3>
              <p className="text-muted-foreground text-sm">
                Mood, energy, brain, era, decision style, workout vibe, and catchphrase energy. Under 90 seconds.
              </p>
            </div>
            <div className="text-center space-y-3">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 text-primary text-xl font-bold">
              ...
              <h3 className="text-lg font-semibold text-foreground">Reveal Your Arnold</h3>
              <p className="text-muted-foreground text-sm">
                Get matched to one of 6 Arnold personas — Terminator, Commando, Kindergarten Cop, Total Recall, True Lies, or Mr. Freeze.
              </p>
            </div>
            <div className="text-center space-y-3">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 text-primary text-xl font-bold">
              ...
              <h3 className="text-lg font-semibold text-foreground">Watch Your Films</h3>
              <p className="text-muted-foreground text-sm">
                Get 2-3 Arnold films that fit your persona, each with signature Arnold commentary. GET TO THE MOVIE!
              </p>
            </div>
          </div>
        </section>

        {/* Persona overview for SEO + curious users */}
        <section className="relative z-10 container mx-auto px-4 py-16 max-w-5xl">
          <h2 className="text-3xl font-bold text-primary mb-8 text-center">
            The Six Arnold Personas
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {personaList.map((p) => (
              <article
                key={p.id}
                className="p-6 border border-border rounded-xl bg-card/40 backdrop-blur-sm hover:bg-card/60 transition-colors"
              >
                ...
                <p className="text-sm text-primary/80 font-semibold uppercase tracking-wider mb-3">
                  {p.tagline}
                </p>
          ...
          <div className="space-y-6">
            <details className="group border border-border rounded-lg p-4 cursor-pointer">
              <summary className="font-semibold text-foreground group-open:text-primary transition-colors">
                Which Arnold Schwarzenegger ARE you?
              </summary>
              <p className="mt-3 text-muted-foreground text-sm leading-relaxed">
                Get to the Movie! matches you to one of 6 Arnold personas: Terminator, Commando, Kindergarten Cop, Total Recall, True Lies, or Mr. Freeze. Take the 7-question quiz above to find out which side of Arnold you are.
              </p>
            </details>
            <details className="group border border-border rounded-lg p-4 cursor-pointer">
              <summary className="font-semibold text-foreground group-open:text-primary transition-colors">
                How does the Arnold persona quiz work?
              </summary>
              <p className="mt-3 text-muted-foreground text-sm leading-relaxed">
                Answer 7 personality-based questions about your mood, energy, brain capacity, era preference, decision style, workout vibe, and catchphrase energy. The quiz scores each persona against your answers and reveals your best match — plus the runner-up — along with 2-3 recommended Arnold films.
              </p>
            </details>
            <details className="group border border-border rounded-lg p-4 cursor-pointer">
              <summary className="font-semibold text-foreground group-open:text-primary transition-colors">
              ...
              <p className="mt-3 text-muted-foreground text-sm leading-relaxed">
                It depends on your Arnold persona. Terminator Arnold favors the Terminator series, Commando Arnold leans into 80s explosion classics, Kindergarten Cop Arnold loves family comedies, Total Recall Arnold picks mind-bending sci-fi, True Lies Arnold enjoys action-comedy, and Mr. Freeze Arnold embraces camp. Take the quiz for a personalized pick.
              </p>
            </details>
            <details className="group border border-border rounded-lg p-4 cursor-pointer">
              <summary className="font-semibold text-foreground group-open:text-primary transition-colors">
              ...
              <p className="mt-3 text-muted-foreground text-sm leading-relaxed">
                Yes! Get to the Movie! is completely free. Take the quiz as many times as you want to discover different Arnold personas and movie recommendations.
              </p>
            </details>
            <details className="group border border-border rounded-lg p-4 cursor-pointer">
              <summary className="font-semibold text-foreground group-open:text-primary transition-colors">
              ...
              <p className="mt-3 text-muted-foreground text-sm leading-relaxed">
                Absolutely! After seeing your result, click &ldquo;Try Again&rdquo; or &ldquo;Try Another Persona&rdquo; to retake the quiz. Different answers lead to different personas and film recommendations.
              </p>
            </details>
          </div>
        </section>
        ...
        <footer className="relative z-10 container mx-auto px-4 py-8 max-w-5xl border-t border-border">
          <div className="flex flex-col gap-6 text-sm text-muted-foreground">
            ...
            >
              ...
              <a
                href="https://beertuner.iamjarl.com"
                className="hover:text-primary transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
